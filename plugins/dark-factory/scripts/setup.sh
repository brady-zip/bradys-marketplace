...
#
# Modes:
#   (default)    apply: create/update managed files, merge settings, run h5i init
...
# The engine never rewrites unrelated settings.json keys, backs settings up
# before any write, and writes atomically.
